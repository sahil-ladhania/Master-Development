...
// 2. Math.ciel() - Rounds a number up to the nearest integer.
// Usage :
...
// 4. Math.random() - Generates a pseudo-random number between 0 (inclusive) and 1 (exclusive).
// Usage :
...
// 5. Math.max() - Returns the highest value among the provided arguments.
// Usage :
...
// 6. Math.min() - Returns the lowest value among the provided arguments.
// Usage :
...
// 7. Math.pow() - Raises a base number to the power of an exponent.
// Usage :
