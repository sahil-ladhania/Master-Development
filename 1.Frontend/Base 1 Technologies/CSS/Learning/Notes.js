...
Explanation :-
* CSS supports 147 predefined color names. Examples include red, blue, green, yellow, black, white, etc.
...
* RGBA (Red, Green, Blue, Alpha) adds an alpha channel (opacity) to RGB. The alpha value ranges from 0 (fully transparent) to 1 (fully opaque).
