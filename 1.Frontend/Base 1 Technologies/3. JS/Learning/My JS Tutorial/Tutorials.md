...
```javascript
    ...
    let shallowCopy = [...arrr];
    shallowCopy[3].push(7);
    console.log(arrr); // Output: [1, 2, 3, [4, 5, 6, 7]]
    // Deep Copy in Array
    let arrrr = [1, 2, 3, [4, 5, 6]];
    let deepCopy = JSON.parse(JSON.stringify(arrrr));
    deepCopy[3].push(7);
    console.log(arrrr);     // Output: [1, 2, 3, [4, 5, 6]]
    console.log(deepCopy); // Output: [1, 2, 3, [4, 5, 6, 7]]
    ...
    shallowCopyObj.b.c = 42;
    console.log(originalObj.b.c); // Expected output: 42
    // Deep Copy in Object
    const originalObj2 = { a: 1, b: { c: 2 } };
    const deepCopyObj = JSON.parse(JSON.stringify(originalObj2));
    deepCopyObj.b.c = 42;
